...
from ladybug_display_schema.geometry3d import Vector3D, Point3D, Ray3D, Plane, LineSegment3D, \
    Polyline3D, Arc3D, Face3D, Mesh3D, Polyface3D, Sphere, Cone, Cylinder

from ladybug_display_schema.display2d import DisplayVector2D, DisplayPoint2D, DisplayRay2D, DisplayLineSegment2D, \
    DisplayPolyline2D, DisplayArc2D, DisplayPolygon2D, DisplayMesh2D
from ladybug_display_schema.display3d import DisplayVector3D, DisplayPoint3D, DisplayRay3D, DisplayPlane, DisplayLineSegment3D, \
    DisplayPolyline3D, DisplayArc3D, DisplayFace3D, DisplayMesh3D, DisplayPolyface3D, DisplaySphere, DisplayCone, DisplayCylinder
...
modules = [
    {'module': [
        Vector2D, Point2D, Ray2D, LineSegment2D, \
        Polyline2D, Arc2D, Polygon2D, Mesh2D, \
        Vector3D, Point3D, Ray3D, Plane, LineSegment3D, \
        Polyline3D, Arc3D, Face3D, Mesh3D, Polyface3D, Sphere, Cone, Cylinder
        ], 'name': 'Geometry'},
    {'module': [
